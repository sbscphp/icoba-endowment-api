...
class CreateCampaignRequest extends ApiFormRequest
{
    ...
    public function messages(): array
    {
        return array_merge(parent::messages(), [
            ...
            'categories.required' => 'Please choose at least one campaign category.',
            ...
            'available_donation_currencies.required' => 'Please select at least one donation currency.',
            ...
            'end_date.required' => 'Please specify an end date.',
            ...
            'graduation_set_uuids.required_if' => 'Please select the graduation sets this campaign applies to.',
