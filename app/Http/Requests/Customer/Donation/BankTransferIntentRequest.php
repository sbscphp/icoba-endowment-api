...
class BankTransferIntentRequest extends ApiFormRequest
{
    ...
    {
        $accountNumbers = App::make(BankAccountRegistry::class)->accountNumbers();
        $accountKeys = App::make(BankAccountRegistry::class)->accountKeys();
        ...
        $base = [
            ...
            'paid_into_account_number' => array_merge(
                ...
                $accountNumbers !== [] ? [Rule::in($accountNumbers)] : []
            ),
        ...
        if ($this->isAuthenticatedMember()) {
            return array_merge($base, $this->memberDonorRules());
        }
